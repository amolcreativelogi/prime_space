...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        <form action="<?php echo url('admin/faq/saveFaq'); ?>" id="formSaveFaq" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
              ...
              <div class="col-sm-10">
               ...
               <select name="category_id" id="category_id" class="form-control">
                ...
                <?php foreach($getCategories as $category){  ?>
                  ...
                  <?php echo  ($category->category_id==Request::get('category_id')) ? 'selected' : ''; ?> 
          ...
          <div class="form-group required">
           ...
           <div class="form-group required">
            ...
            <a  id="faqSaveNext" data-toggle="tooltip" title=""  class="btn btn-success pull-right" data-original-title="faqSaveNext" onclick="saveFaq()">Save And Next</a>
            <input type="hidden" value="" id="frmSubmitFlag" name="frmSubmitFlag">
...
<script>
  ...
  //submit form on click of save and next
   $("#faqSaveNext").click(function(){
    $('#frmSubmitFlag').val('faqSaveNext');
    $('#formSaveFaq').submit();
  });

  $("#faqSave").click(function(){
    $('#frmSubmitFlag').val('');
  });

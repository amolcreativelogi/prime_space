  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo url('admin/carTypeExecute'); ?>" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Back"><i class="fa fa-reply"></i></a></div>
      <h1> Car Type</h1>
    </div>
  </div>
  <div class="container-fluid">
           ...
           <div class="form-group required">
            ...
            <div class="col-sm-10">
               <select name="status" id="status" class="form-control">
                ...
                <option value="0" <?php echo  ($editCarType && $editCarType->status == 0) ? 'selected' : ''; ?>>Inactive</option>
               </select>
             </div>
           </div>

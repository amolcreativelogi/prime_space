  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo url('admin/unitTypeExecute'); ?>" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
      <h1> Unit Type</h1>
    </div>
  </div>
  <div class="container-fluid">
           ...
           <div class="form-group required">
            ...
            <div class="col-sm-10">
               <select name="status" id="status" class="form-control">
                ...
                <option value="0" <?php echo  ($editUnitType && $editUnitType->status == 0) ? 'selected' : ''; ?>>In Active</option>
               </select>
             </div>
           </div>

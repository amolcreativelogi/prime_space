                        ...
                        <form id="login-form" action="/site/login" method="post">
                            ...
                            <div class="form-group text-center">
                              <ul class="social-login">
                                <li><a class="google auth-link" href="#" title="Google"><i class="fa fa-google" aria-hidden="true"></i>Google</a></li>
                                <li><a class="facebook auth-link" href="#" title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i>Facebook</a></li>
                                <li><a class="linkedin auth-link" href="#" title="Google"><i class="fa fa-linkedin" aria-hidden="true"></i>Linkedin</a></li> 
                              </ul>
                            </div>

    ...
    <section class="ap-filter">
      <div class="container">
                ...
                <div id="2" class="parking-slection">
                      <div class="prop-type">
                            <nav>
                                ...
                                <button data-toggle="collapse" data-target="#parking-aminities" class="aminities-collapse"><i class="fa fa-bars" aria-hidden="true"></i></button>
                                ...
                                <select class="filter-select" name="data[parking][parking_type_id][]">
                            ...
                            <div id="parking-aminities" class="collapse aminities-collapse-div">
        ...
        <!-- Tab panes -->
            ...
            <div id="land-aminities" class="collapse aminities-collapse-div">
                <ul class="aminities-list custom-checkbox" id="amenities_list">
                    <li><input type="checkbox" name="data[amenities][]" id="Electric Supply" value="60"><label for="Electric Supply">Electric Supply <img src="https://www.prymestory.com/public/images/amenity/electric supply.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Water supply" value="58"><label for="Water supply">Water supply <img src="https://www.prymestory.com/public/images/amenity/water supply.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Security" value="57"><label for="Security">Security <img src="https://www.prymestory.com/public/images/amenity/security.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Wifi" value="55"><label for="Wifi">Wifi <img src="https://www.prymestory.com/public/images/amenity/wifi.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Fire Extinguisher" value="61"><label for="Fire Extinguisher">Fire Extinguisher <img src="https://www.prymestory.com/public/images/amenity/fire extinguisher.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Boundary wall" value="63"><label for="Boundary wall">Boundary wall <img src="https://www.prymestory.com/public/images/amenity/boundary wall.svg" width="50"></label></li>
                    <li><input type="checkbox" name="data[amenities][]" id="Parking Facility" value="64"><label for="Parking Facility">Parking Facility <img src="https://www.prymestory.com/public/images/amenity/parking facility.svg" width="50"></label></li>
                </ul>
            </div>
                <div class="tab-content" id="nav-tabContent">

     ...
     @include('front/includes.host_side_menu')
      <div class="col-lg-10 col-md-10 col-sm-12 dl-content">
        ...
        <div class="dashfilter">
          ...
          <div class="date">
            <input type="text" name="up_search_to_date" placeholder="Search By To date" id="transtodate">
          </div>
          <input type="button" class="filtersearch" name="search" id="search" onclick="SearchUpcomingBooking()">
        </div>
...
function SearchUpcomingBooking()
{
  ...
  var up_search_from_date = $('#transtodate').val();
  var up_search_to_date = $('#transfromdate').val();

  var url = "<?php echo URL::to('user/upcomingBooking'); ?>?parking_typ="+parking_type+"&&up_search_from_date="+up_search_from_date+"&&up_search_to_date="+up_search_to_date+"";
  window.location = url;
}
</script>
@stop

                ...
                <div class="col-sm-6">
                  <div class="form-group field-updateprofileform-address required updateprofileimg">
                    ...
                    if($userdetails->profile_pic) { 
                      ...
                      ?> 
                      <img id="blah" src="<?php echo $profiepic; ?>" title="" alt="">
                    <?php } else {  ?>
                    ...
                    <?php } ?>
                     ...
                     <div class="box custom-fileinput">
                        <input type="file" name="profile_pic" id="profile-img" class="inputfile inputfile-6" onchange="readURL(this);" />
                        <label for="profile-img"><strong>Choose profile picture</strong></label>
                      </div>
                        <input type="hidden" name="edit_profile_pic" id="edit_profile_pic"  value="<?php echo $userdetails->profile_pic; ?>"/>

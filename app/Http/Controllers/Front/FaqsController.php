...
class FaqsController extends Controller {
  ...
  { 
    ...
    ->where(['tbl_faqs.status'=>1,'tbl_faqs.is_deleted'=>0,'tbl_mstr_faq_categories.status'=>1,'tbl_mstr_faq_categories.is_deleted'=>0])->orderBy('tbl_faq_sequence.sequence')->get();

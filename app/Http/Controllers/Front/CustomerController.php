...
class CustomerController extends Controller
{
	...
	public function bookingHistory()
    {
        $bookingDatas = DB::table('tbl_property_bookings')
                            ->join('prk_add_property', 'prk_add_property.property_id', 'tbl_property_bookings.property_id') ->join('prk_user_registrations', 'prk_user_registrations.user_id', 'prk_add_property.user_id')->where('tbl_property_bookings.user_id', '=', $_SESSION['user']['user_id'])->get();
